...
public class GameRenderer {
    ...
    public void render(float runTime) {
        ...
        if(this.myWorld.isReady()) {
            AssetLoader.font.draw(this.batcher, "Touche me", 27.0F, 75.0F);
        } else {
            if(this.myWorld.isGameOver() || this.myWorld.isHighScore()) {
                if(this.myWorld.isGameOver()) {
                    AssetLoader.font.draw(this.batcher, "Game Over", 24.0F, 55.0F);
                    AssetLoader.font.draw(this.batcher, "High Score:", 22.0F, 105.0F);
                    score = AssetLoader.getHighScore() + "";
                    AssetLoader.font.draw(this.batcher, score, (float)(68 - (3 * score.length() - 1)), 127.0F);
                } else {
                    AssetLoader.font.draw(this.batcher, "High Score!", 18.0F, 55.0F);
                }

                AssetLoader.font.draw(this.batcher, "Try again?", 24.0F, 75.0F);
                score = this.myWorld.getScore() + "";
                AssetLoader.font.draw(this.batcher, score, (float)(68 - (3 * score.length() - 1)), 11.0F);
            }
